...
export class NewMigration1686851296027 implements MigrationInterface {
  name = 'NewMigration1686851296027';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "favorites" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "artists" text NOT NULL DEFAULT '[]', "albums" text NOT NULL DEFAULT '[]', "tracks" text NOT NULL DEFAULT '[]', CONSTRAINT "PK_890818d27523748dd36a4d1bdc8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
